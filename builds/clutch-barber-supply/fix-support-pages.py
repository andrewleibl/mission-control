...
support_pages = ['preview-returns.html', 'preview-shipping.html', 'preview-privacy.html', 'preview-terms.html']
...
for fname in support_pages:
    ...
    if 'clutch-header__menu' in content:
        print(f"{fname} already has mobile menu, checking links...")
        # Just fix localhost links
...
'''
    ...
    # Also try without localhost prefix
    content = content.replace(
        '<a href="preview-homepage-complete.html" class="clutch-header__logo">',
        '<button class="clutch-header__menu" aria-label="Open menu"><span></span><span></span><span></span></button><a href="preview-homepage-complete.html" class="clutch-header__logo">'
    )
...
(function() {
  ...
  overlay.addEventListener('click', closeNav);
    ...
    print(f"Fixed {fname} with mobile menu!")

print("\nAll support pages updated!")
